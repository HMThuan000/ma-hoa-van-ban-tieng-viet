# Form implementation generated from reading ui file 'D:\ĐẠI HỌC\ĐẠI HỌC\BẢO MẬT\DETAI_BMHTTT\View\ThietKe\ThietKeMaHoaXORBelasco.ui'
#
...
"")
        ...
        self.txtCiphertext.setGeometry(QtCore.QRect(410, 370, 671, 211))
...
"background-color: rgb(0, 0, 15);")
        ...
        self.btnOpenFile.setGeometry(QtCore.QRect(820, 290, 93, 28))
        self.btnOpenFile.setStyleSheet("QPushButton#btnOpenFile{\n"
...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(410, 290, 131, 31))
        self.label_3.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_3.setObjectName("label_3")
        self.btnMaHoa = QtWidgets.QPushButton(parent=Dialog)
        self.btnMaHoa.setGeometry(QtCore.QRect(980, 290, 93, 28))
...
"}")
        ...
        self.label_4.setGeometry(QtCore.QRect(410, 350, 181, 16))
        self.label_4.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_4.setObjectName("label_4")
        self.txtKey = QtWidgets.QTextEdit(parent=Dialog)
        self.txtKey.setGeometry(QtCore.QRect(570, 290, 111, 31))
...
"background-color: rgb(0, 0, 15);")
        ...
        self.btnClose.setGeometry(QtCore.QRect(980, 590, 93, 28))
...
"}")
        ...
        self.btnSaveFile.setGeometry(QtCore.QRect(820, 590, 93, 28))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Mã hoá XOR Belasco"))
        self.label_2.setText(_translate("Dialog", "Nhập nội dung cần mã hoá:"))
        self.btnOpenFile.setText(_translate("Dialog", "Mở file"))
        self.label_3.setText(_translate("Dialog", "Nhập key (chuỗi ký tự):"))
