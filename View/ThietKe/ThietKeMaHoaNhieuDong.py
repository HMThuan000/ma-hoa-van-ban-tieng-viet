# Form implementation generated from reading ui file 'D:\ĐẠI HỌC\ĐẠI HỌC\BẢO MẬT\DETAI_BMHTTT\View\ThietKe\ThietKeMaHoaNhieuDong.ui'
#
...
"background-color: rgb(0, 0, 15);")
        ...
        self.background_img.setGeometry(QtCore.QRect(-60, -70, 1221, 761))
...
"}")
        ...
        self.txtPlaintext.setGeometry(QtCore.QRect(390, 70, 671, 211))
        self.txtPlaintext.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(0, 0, 15);")
        self.txtPlaintext.setObjectName("txtPlaintext")
        self.label_3 = QtWidgets.QLabel(parent=Dialog)
        self.label_3.setGeometry(QtCore.QRect(390, 290, 161, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Nhập số lượng phần từ key của n"))
        self.label_2.setText(_translate("Dialog", "Nhập nội dung cần mã hoá:"))
        self.label.setText(_translate("Dialog", "Mã hoá nhiều dòng"))
