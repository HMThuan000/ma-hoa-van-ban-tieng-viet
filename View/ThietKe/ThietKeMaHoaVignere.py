# Form implementation generated from reading ui file 'D:\ĐẠI HỌC\ĐẠI HỌC\BẢO MẬT\DETAI_BMHTTT\View\ThietKe\ThietKeMaHoaVignere.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(390, 40, 181, 16))
        self.label_2.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_2.setObjectName("label_2")
        self.btnMaHoa = QtWidgets.QPushButton(parent=Dialog)
        self.btnMaHoa.setGeometry(QtCore.QRect(960, 290, 93, 28))
...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("D:/ĐẠI HỌC/ĐẠI HỌC/BẢO MẬT/DETAI_BMHTTT/View/Image_and_icons/fl-feature-lock-folders.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.On)
        self.btnMaHoa.setIcon(icon)
        self.btnMaHoa.setObjectName("btnMaHoa")
        self.btnOpenFile = QtWidgets.QPushButton(parent=Dialog)
        self.btnOpenFile.setGeometry(QtCore.QRect(800, 290, 93, 28))
...
"}")
        ...
        self.label_4.setGeometry(QtCore.QRect(390, 350, 181, 16))
        self.label_4.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_4.setObjectName("label_4")
        self.txtKey = QtWidgets.QTextEdit(parent=Dialog)
        self.txtKey.setGeometry(QtCore.QRect(550, 290, 111, 31))
...
"}")
        ...
        self.txtCiphertext.setGeometry(QtCore.QRect(390, 370, 671, 211))
...
"background-color: rgb(0, 0, 15);")
        ...
        self.btnSaveFile.setGeometry(QtCore.QRect(800, 590, 93, 28))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Mã hóa Vignere"))
